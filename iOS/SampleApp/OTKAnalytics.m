...
- (void) checkData {
    ...
    if ( _data.sessionId == nil || [ _data.sessionId length ]==0 ) {
        NSLog (@"The sessionId field cannot be null in the log entry");
        e = [NSException exceptionWithName:@"AnalyticsException"
                                    reason:@"*The sessionId field cannot be null in the log entry*"
                                  userInfo:nil];
        @throw e;
    }
    
    if ( _data.connectionId == nil || [ _data.connectionId length ]==0 ) {
        NSLog (@"The connectionId field cannot be null in the log entry");
        e = [NSException exceptionWithName:@"AnalyticsException"
                                    reason:@"*The connectionId field cannot be null in the log entry*"
                                  userInfo:nil];
        @throw e;    }
    
    if ( _data.partnerId == 0 ) {
        NSLog (@"The partnerId field cannot be null in the log entry");
        e = [NSException exceptionWithName:@"AnalyticsException"
                                    reason:@"*The partnerId field cannot be null in the log entry*"
                                  userInfo:nil];
        @throw e;
    }
    
    if ( _data.clientVersion == nil || [ _data.clientVersion length ]==0 ) {
        NSLog (@"The clientVersion field cannot be null in the log entry");
        e = [NSException exceptionWithName:@"AnalyticsException"
                                    reason:@"*The clientVersion field cannot be null in the log entry*"
                                  userInfo:nil];
        @throw e;
    }
