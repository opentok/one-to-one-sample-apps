 ...
 */
typedef void (^TextChatViewEventBlock)(TextChatViewEventSignal signal, TextMessage *textChat, NSError *error);

@class TextChatView;

@protocol TextChatViewDataSource <NSObject>

- (void)textChatView:(TextChatView *)textChatView numberOfRowsInSection:(NSInteger)section;

- (UITableViewCell *)textChatView:(TextChatView *)textChatView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
@end
...
- (void)textChatView:(TextChatView *)textChatView
     didSendtextChat:(TextMessage *)textChat
               error:(NSError *)error;
 ...
 */
- (void)textChatView:(TextChatView *)textChatView
  didReceiveTextChat:(TextMessage *)textChat;
